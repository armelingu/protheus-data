var API_BASE = '/api/relatorios/compras/historico';
...
function baixarRelatorio() {
    ...
    mostrarMensagem(
        filtros ? 'Aguarde, gerando histórico filtrado...' : 'Aguarde, gerando histórico de pedidos...',
        'processando'
    );
    ...
    fetch(API_BASE + '/download?formato=' + formato + filtros)
        ...
        .then(function(blob) {
            ...
            a.href = url;
            a.download = 'historico_pedidos' + ext;
...
function atualizarDados() {
    ...
    mostrarMensagem('Sincronizando histórico de pedidos...', 'processando');
