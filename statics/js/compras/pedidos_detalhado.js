var API_BASE = '/api/relatorios/compras/pedidos-detalhado';
...
function baixarRelatorio() {
    ...
    mostrarMensagem(
        filtros ? 'Aguarde, gerando relatório filtrado...' : 'Aguarde, gerando relatório de pedidos detalhado...',
        'processando'
    );
    ...
    fetch(API_BASE + '/download?formato=' + formato + filtros, { credentials: 'same-origin' })
        ...
        .then(function(blob) {
            ...
            a.href = url;
            a.download = 'pedidos_compra_detalhado' + ext;
...
function atualizarDados() {
    ...
    mostrarMensagem('Sincronizando pedidos de compra detalhado...', 'processando');
