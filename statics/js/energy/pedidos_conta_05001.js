var API_BASE = '/api/relatorios/energy/pedidos-conta-05001';
...
function baixarRelatorio() {
    ...
    mostrarMensagem(
        filtros ? 'Aguarde, gerando relatório filtrado...' : 'Aguarde, gerando relatório de pedidos Conta 05.001...',
        'processando'
    );
    ...
    fetch(API_BASE + '/download?formato=' + formato + filtros, { credentials: 'same-origin' })
        ...
        .then(function(blob) {
            ...
            a.href = url;
            a.download = 'pedidos_conta_05001' + ext;
...
function atualizarDados() {
    ...
    mostrarMensagem('Sincronizando pedidos Conta 05.001...', 'processando');
